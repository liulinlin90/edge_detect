...
def split_data(data_dir,augment_both=True):
    ...
    for i in range(n):
        ...
        cut_img_width = int(img_width * 9.0/10)
        if cut_img_width < 500:
        ...
        if augment_both:
            ...
            gt_tmp1 = gt_tmp[:, 0:int(img_width* 2.0/3)]
            gt_tmp2 = gt_tmp[:, int(img_width/3.0):img_width]
...
def augment_data(base_dir,augment_both, use_all_type=True):
    ...
    data_dir = base_dir 
    img_dir_old = os.path.join(data_dir,'imgs') # path for image augmentation
    if augment_both:
        gt_dirs = []
        gt_dirs.append(os.path.join(data_dir,'hl', '1'))
        gt_dirs.append(os.path.join(data_dir,'hl', '2'))
        gt_dirs.append(os.path.join(data_dir,'hl', '3'))
        gt_dirs.append(os.path.join(data_dir,'hl', '4'))
        gt_dirs.append(os.path.join(data_dir,'hl', '5'))
        gt_dirs.append(os.path.join(data_dir,'hl', '6'))
        gt_dirs.append(os.path.join(data_dir,'hl', '7'))
        gt_dirs.append(os.path.join(data_dir,'hl', '8'))
        gt_dirs.append(os.path.join(data_dir,'hl', '9'))
        gt_dirs.append(os.path.join(data_dir,'hl', '10'))
        gt_dirs.append(os.path.join(data_dir,'hl', '11'))
        gt_dirs.append(os.path.join(data_dir,'hl', '12'))
        gt_dirs.append(os.path.join(data_dir,'hl', '13'))

    dataset_dirs0 = [img_dir_old, gt_dirs[0]]
    dataset_dirs1 = [gt_dirs[1], gt_dirs[2]]
    dataset_dirs2 = [gt_dirs[3], gt_dirs[4]]
    dataset_dirs3 = [gt_dirs[5], gt_dirs[6]]
    dataset_dirs4 = [gt_dirs[7], gt_dirs[8]]
    dataset_dirs5 = [gt_dirs[9], gt_dirs[10]]
    dataset_dirs6 = [gt_dirs[11], gt_dirs[12]]
    for dataset_dirs in [dataset_dirs0, dataset_dirs1, dataset_dirs2, dataset_dirs3,
        dataset_dirs4, dataset_dirs5, dataset_dirs6]:
        img_dir, gt_dir = dataset_dirs
        rotation = False
        splitting_up = True
